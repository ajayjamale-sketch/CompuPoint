...
export default function FAQ() {
  ...
  return (
    <div className="min-h-screen bg-background pt-16">
      {/* Hero */}
      <section className="py-16 px-4 bg-slate-50 dark:bg-gradient-hero border-b border-border relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative">
          ...
          <div className="relative max-w-lg mx-auto">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3.5 bg-white dark:bg-white/10 border border-slate-200 dark:border-white/20 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-400 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 text-base shadow-sm"
            />
          </div>
        </div>
      </section>
